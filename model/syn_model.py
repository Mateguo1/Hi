...
class Multi_modal_generator(nn.Module):
    ...
    def forward(self,inputs):
        ...
        # -----  Second Level --------
        # to down_fu_1
        down_1_0m   = self.pool_1_0(down_1_0)# Max-pool
        down_1_1m   = self.pool_1_1(down_1_1)# Max-pool
        ...
        # -----  Third Level --------
        # to down_fu_2
        down_2_0m = self.pool_2_0(down_2_0)# Max-pool
        down_2_1m = self.pool_2_1(down_2_1)# Max-pool
                
        down_3_0 = self.down_3_0(down_2_0m)
        down_3_1 = self.down_3_1(down_2_1m)
        
        down_3_0m = self.pool_3_0(down_3_0)# Max-pool
        down_3_1m = self.pool_3_1(down_3_1)# Max-pool
         
        # -----  Fusion Network --------
        # fu_in(n) = max(m)×2+fu_max(n-1)
